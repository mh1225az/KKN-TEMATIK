...
<head>
    ...
    <title>KKN TEMATIK KENDARI</title>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="assets\img\logo1.png" class="foto" style="
                                display: flex;
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <h1 class="h4 text-gray-900 mb-4" style="color: black !important;"><b>Selamat Datang</b></h1>
                                    </div>
                                    <?php            
                                    if($_POST) {
                                        include 'aksi.php';  
